...
<div class="clearboth"></div><br/>
    ...
    <div class="report_container scheda" style="height: auto;width: 90%;float: left;margin-left: 10px;margin-bottom: 10px;padding: 5px;">
        <div id="report_table" class="report">
            <!--<div class="report_name" style="float: left"><?=$report['name']?></div>
            <div style="float: right">
                <div class="btn_scritta" onclick="selezione_viste_report(this,'<?=$report['tableid']?>','<?=$report['reportid']?>')">Viste</div>
                <div class="btn_scritta" onclick="elimina_report(this,'<?=$report['reportid']?>')">Del</div>
            </div>-->
        <?=$report['block']?>
        </div>
    </div>
