...
//custom demo svicom
if(($layout_scheda=='standard_dati')&&($tableid=='fax'))
{
...
<div class="menu_mid menu_top ui-widget-header">
            ...
            <div class="btn_scritta menu_list_button" style="float: right;">
                    ...
                    <ul id="menu_stampe" class="menu_list" style="width:150px;">
                        ...
                        <?php            
                        if($data['settings']['cliente_id']=='Work&Work')
                        {
                            ?>
...
<?php
    ...
    {
    ?>
    <div class="ui-widget-header menu_big" style="position: absolute;bottom: 0px;width: 98%;margin: auto;border: 0px;background-color: white;">
        <?php
        if($target=='popup')
        {
        ?>
        ...
        ?>
        <div id="btnInserisci" class="btn_scritta" onclick="inserisci(this,'caricaonline')" style="float: left;"><div class="fa fa-envelope"></div>Salva e Carica Online</div>
        <div class="clearboth"></div>
    </div>
    <?php
    }
