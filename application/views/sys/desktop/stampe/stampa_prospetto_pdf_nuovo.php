...
<div class="print_page" style=''>
        ...
        <div style="height: 80mm;width: 70%;margin: auto;margin-top: 20mm;overflow: hidden">
            ...
            <div style="font-size: 28pt;font-weight: bold;text-align: center;margin-top: 0mm"><?=$tipo?></div>
            <div style="font-size: 28pt;font-weight: bold;text-align: center;margin-top: 5mm"><?=$titoletto?></div>
        ...
        <div style="height: 161mm;width: 242mm;margin: auto;margin-top: 10mm">
            <img src="<?=domain_url().$foto_copertina['path']?>" style="">
        </div>
        <div style="text-align: center;margin-top: 10mm;">
            Sede sottoceneri: Via Carlo Maderno, 9 - CH - 6900 Lugano - Tel. +41 (0)91 922 74 00<br/>
            Sede sopraceneri: Via Bellinzona 1 - CH - 6512 Giubiasco - Tel. +41 (0)91 857 19 07<br/>
                ...
                <div class="print_page" >
                    ...
                    if($foto_rimanenti>=5)
                    {
                        for ($foto_per_pagina_index = 0; $foto_per_pagina_index < $foto_per_pagina; $foto_per_pagina_index++) 
                        {
                            ...
                            {
                            ?>
                                <img style="height: 161mm;width: 241mm;margin: 0.5;float: left;margin-top: 1mm;margin-left: 1mm;margin-bottom: 1mm" src="<?=domain_url().$photo?>">
                            <?php
                            }
                            else
                            {
                            ?>  
                                <img style="height: 80mm;width: 120mm;float: left;margin-top: 1mm;margin-left: 1mm;margin-bottom: 1mm" src="<?=domain_url().$photo?>">
                            <?php
                            }
                            $photos_array_index++;
                        }
                    ...
                    else
                    {
                        ...
                        {
                        ?>
                            <img style="height: 161mm;width: 241mm;margin: 0.5;float: left;margin-top: 1mm;margin-left: 1mm;margin-bottom: 1mm" src="<?=domain_url().$photos[$photos_array_index];?>"> 
                            <img style="height: 161mm;width: 241mm;margin: 0.5;float: left;margin-top: 1mm;margin-left: 1mm;margin-bottom: 1mm" src="<?=domain_url().$photos[$photos_array_index+1];?>"> 
                        <?php
                        }
                        if($foto_rimanenti==3)
                        {
                        ?>
                            <img style="height: 80mm;width: 120mm;float: left;margin-top: 1mm;margin-left: 1mm;margin-bottom: 1mm" src="<?=domain_url().$photos[$photos_array_index];?>"> 
                            <img style="height: 80mm;width: 120mm;float: left;margin-top: 1mm;margin-left: 1mm;margin-bottom: 1mm" src="<?=domain_url().$photos[$photos_array_index+1];?>"> 
                            <img style="height: 161mm;width: 241mm;margin: 0.5;float: left;margin-top: 1mm;margin-left: 1mm;margin-bottom: 1mm" src="<?=domain_url().$photos[$photos_array_index+2];?>"> 
                        <?php
                        }
                        if($foto_rimanenti==4)
                        {
                        ?>
                            <img style="height: 80mm;width: 120mm;float: left;margin-top: 1mm;margin-left: 1mm;margin-bottom: 1mm" src="<?=domain_url().$photos[$photos_array_index];?>"> 
                            <img style="height: 80mm;width: 120mm;float: left;margin-top: 1mm;margin-left: 1mm;margin-bottom: 1mm" src="<?=domain_url().$photos[$photos_array_index+1];?>"> 
                            <img style="height: 80mm;width: 120mm;float: left;margin-top: 1mm;margin-left: 1mm;margin-bottom: 1mm" src="<?=domain_url().$photos[$photos_array_index+2];?>">
                            <img style="height: 80mm;width: 120mm;float: left;margin-top: 1mm;margin-left: 1mm;margin-bottom: 1mm" src="<?=domain_url().$photos[$photos_array_index+3];?>">
                        <?php
                        }
                    ?>   
...
<div class="print_page" >
    ...
    ?>
        ...
        <div>
            ...
            {
            ?>
                <img src="<?=domain_url().$foto_descrizione?>" style="height: 161mm;width: 241mm;margin: auto;margin-top: 5mm;display: block">
            <?php
            }
            ?>
        </div>
        ...
        <div class="print_page">
            ...
            ?>
                <div style="margin-top: 10mm">
                    <img  style="height: 330mm;width: auto;margin: auto;display: block;" src="<?=domain_url().$foto_piantina['path_rotated']?>">
                </div>
            <?php
            }
            else
            ...
            ?>
                <div style="width: 100%">
                    <img  style="height: 250mm;" src="<?=domain_url().$foto_piantina['path']?>">
                </div>
            <?php
            }*/
            ...
            ?>
                <div>
                    <img  style="width: 242mm;height: auto;display: block;margin: auto" src="<?=domain_url().$foto_piantina['path']?>">
                </div>
            <?php
            }
            else
            ...
            ?>
                <div>
                    <img  style="height: 340mm;width: auto;display: block;margin: auto" src="<?=domain_url().$foto_piantina['path']?>">
                </div>
            <?php
            } 
            ?>
...
<br />
    ...
    <div style="width: 180mm;height: 170mm;margin-top: 70mm;">
        <div style="height: 60mm;overflow: hidden;">
            <div style="float: left;width: 60mm;height: 60mm;">
                <img src="<?=domain_url().'/JDocWeb/assets/images/custom/DimensioneImmobiliare/maps_lugano.jpg'?>">
            </div>
        ...
        <div style="height: 60mm;overflow: hidden;margin-top: 20mm;">
            <div style="float: left;width: 60mm;height: 60mm;">
                <img src="<?=domain_url().'/JDocWeb/assets/images/custom/DimensioneImmobiliare/maps_giubiasco.jpg'?>">
            </div>
            <div style="float: left;width: 110mm;height: 100%;margin-left: 5mm;">
