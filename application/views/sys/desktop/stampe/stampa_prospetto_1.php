...
//PAESE
$table->addRow(400);
$table->addCell(10900)->addText(strtoupper($dati['paese']),array('size'=>20,'bold'=>true,'underline'=>PHPWord_Style_Font::UNDERLINE_SINGLE,'color'=>'#4A442A'),array('align'=>'center'));

//TITOLO
$table->addRow(400);
$table->addCell(10900,array('valign'=>'center'))->addText('VILLA MODERNA',array('size'=>20,'bold'=>true,'underline'=>PHPWord_Style_Font::UNDERLINE_SINGLE,'color'=>'#4A442A'),array('align'=>'center'));
...
if($foto_interni!=null)
{
    ...
    foreach ($foto_interni as $key => $foto_interno) {
        ...
        $cell = $table->addCell(5000,array('valign'=>'center','borderSize'=>18,'borderColor'=>'#4A442A','spacing'=>0,'spaceAfter=>'=>0));
        $cell->addImage($foto_interno,array('width'=>330,'height'=>400,'align'=>'center'));
    }
...
$cell = $table->addCell(10900,array('valign'=>'center','spacing'=>0,'spaceAfter'=>0,'spaceBefore'=>10));
$cell->addImage("assets/images/DimensioneImmobilare_footer_prospetto.png", array('width'=>600,'height'=>120,'align'=>'center'));
//FINE FOOTER
