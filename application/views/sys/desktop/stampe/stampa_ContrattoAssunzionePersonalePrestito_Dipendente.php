...
$document = $PHPWord->loadTemplate("stampe/modelli/contratti$wwws/ContrattoAssunzionePersonalePrestito_Dipendente.docx");
...
$document->save('stampe/'.$data['userid'].'/ContrattoAssunzionePersonalePrestito_Dipendente.docx');
?>
