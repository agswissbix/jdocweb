...
<div style="color: red">LISTA DIPENDENTI DA CHIUDERE</div>
</div>
...
?>
    <tr style="<?=$tr_css?>">
        <td><?=$row['id']?></td><td><?=$row['cognome']?></td><td><?=$row['nome']?></td><td style="color: red"></td><td><?=$row['zonelavorative']?></td><td></td><td></td><td></td><td><?=$row['notegenerali']?></td>
    </tr>
<?php    
}
?>
