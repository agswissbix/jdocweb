...
$document = $PHPWord->loadTemplate("stampe/modelli/contratti$wwws/ContrattoFornituraPersonalePrestito_WW.docx");
...
$document->save('stampe/'.$data['userid'].'/ContrattoFornituraPersonalePrestito_WW.docx');
?>
