...
Lo staff di About X SA 
    ...
    public function ajax_invia_stampa_avanzata()
    {
        ...
        if($tableid=='immobili')
        {
            ...
            $data['mailsubject']="Richiesta - $paese $categoria $locali $tipo ID:$riferimento  ";
            $mailbody="
...
";
   ...
   /* public function load_block_emptyfields_table($tableid,$label='null',$table_index,$table_param,$type,$funzione='null',$recordid='null',$interface='desktop'){
    ...
    {  
        ...
        $query=$post['query'];
        $page=$post['page'];
        $block=  $this->load_block_results($tableid,$contesto,$query,$master_tableid,$page);
        echo $block;
    }
    
    public function load_block_results($tableid,$contesto=null,$query='',$master_tableid='',$page,$order_key='',$order_ascdesc='')
    {   
...
*/
    ...
    public function conferma_queued_mail($recordid)
    {
        ...
        $recordid_immobile='';
        if(array_key_exists('recordidimmobili_', $queued_mail))
        {
            ...
            if(isnotempty($recordid_immobile))
            {
                ...
                if((isnotempty($recordid_proprietario))&&($tipo=='invioprospetto'))
                {
                    echo 'protezionecliente';
                }
            }
    ...
    public function custom_3p_aggiornamedie()
    {
        $command='cd ../JDocServices && aggiornamedie.bat';
        exec($command);
    }
