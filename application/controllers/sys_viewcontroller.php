...
*/
    ...
    {
        $sql="SELECT * FROM user_contratti WHERE (datafine is null AND datadisdetta is null) OR datafine>'2022-01-01' OR datadisdetta>'2022-01-01' ORDER BY ID desc";
    ...
    public function docuware_import()
    {
        ...
        {
            $sql="
                SELECT TOP (1500) DW_Archivio_Dipendenti_SEC.ID,DW_Archivio_Dipendenti_SEC.DOCID,DW_Archivio_Dipendenti_SEC.LOCATION,TIPO_DOCUMENTO_ AS TIPO
    ...
    { 
        $rows= $this->Sys_model->db_get('user_presenzemensili','*',"anno=2023 and mese=7 and recordid_='00000000000000000000000000047475'");
        foreach ($rows as $key => $row) {
